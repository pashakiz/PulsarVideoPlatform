...
--
-- Хост: localhost:3306
-- Время создания: Мар 24 2016 г., 10:37
...
--
-- База данных: `u0081082_pulsar`
--

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_assets`
--

CREATE TABLE IF NOT EXISTS `pvp_assets` (
...
--
-- Дамп данных таблицы `pvp_assets`
--

INSERT INTO `pvp_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(54, 18, 70, 71, 2, 'com_modules.module.87', 'header', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(55, 18, 72, 73, 2, 'com_modules.module.88', 'Преимущества', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(56, 18, 74, 75, 2, 'com_modules.module.89', 'text1', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(57, 18, 76, 77, 2, 'com_modules.module.90', 'bullets', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(58, 18, 78, 79, 2, 'com_modules.module.91', 'text2', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(59, 18, 80, 81, 2, 'com_modules.module.92', 'Опции (formats)', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(60, 18, 82, 83, 2, 'com_modules.module.93', 'feedback', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(61, 18, 84, 85, 2, 'com_modules.module.94', 'partners', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(62, 18, 86, 87, 2, 'com_modules.module.95', 'footer', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}');

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_associations`
--

CREATE TABLE IF NOT EXISTS `pvp_associations` (
...
--
-- Структура таблицы `pvp_banners`
--

CREATE TABLE IF NOT EXISTS `pvp_banners` (
...
--
-- Структура таблицы `pvp_banner_clients`
--

CREATE TABLE IF NOT EXISTS `pvp_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Структура таблицы `pvp_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `pvp_banner_tracks` (
...
--
-- Структура таблицы `pvp_categories`
--

CREATE TABLE IF NOT EXISTS `pvp_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pvp_categories`
--

INSERT INTO `pvp_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Структура таблицы `pvp_contact_details`
--

CREATE TABLE IF NOT EXISTS `pvp_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `pvp_content`
--

CREATE TABLE IF NOT EXISTS `pvp_content` (
...
--
-- Структура таблицы `pvp_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `pvp_contentitem_tag_map` (
...
--
-- Структура таблицы `pvp_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `pvp_content_frontpage` (
...
--
-- Структура таблицы `pvp_content_rating`
--

CREATE TABLE IF NOT EXISTS `pvp_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pvp_content_types`
--

CREATE TABLE IF NOT EXISTS `pvp_content_types` (
...
--
-- Дамп данных таблицы `pvp_content_types`
--

INSERT INTO `pvp_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Структура таблицы `pvp_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `pvp_core_log_searches` (
...
--
-- Структура таблицы `pvp_extensions`
--

CREATE TABLE IF NOT EXISTS `pvp_extensions` (
...
--
-- Дамп данных таблицы `pvp_extensions`
--

INSERT INTO `pvp_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"b19ca081326ec5478f66df66e79bd549"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Структура таблицы `pvp_finder_filters`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_filters` (
...
--
-- Структура таблицы `pvp_finder_links`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links` (
...
--
-- Структура таблицы `pvp_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms0` (
...
--
-- Структура таблицы `pvp_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pvp_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `pvp_finder_taxonomy`
--

INSERT INTO `pvp_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `pvp_finder_terms`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_terms` (
...
--
-- Структура таблицы `pvp_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `pvp_finder_terms_common`
--

INSERT INTO `pvp_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `pvp_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pvp_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `pvp_finder_types`
--

CREATE TABLE IF NOT EXISTS `pvp_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `pvp_languages`
--

CREATE TABLE IF NOT EXISTS `pvp_languages` (
...
--
-- Дамп данных таблицы `pvp_languages`
--

INSERT INTO `pvp_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_menu`
--

CREATE TABLE IF NOT EXISTS `pvp_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pvp_menu`
--

INSERT INTO `pvp_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Дамп данных таблицы `pvp_menu_types`
--

INSERT INTO `pvp_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_messages`
--
...
--
-- Структура таблицы `pvp_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `pvp_messages_cfg` (
...
--
-- Структура таблицы `pvp_modules`
--

CREATE TABLE IF NOT EXISTS `pvp_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Дамп данных таблицы `pvp_modules`
--

INSERT INTO `pvp_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 54, 'header', '', '			<div class="logo"></div>\r\n			<div class="devices-img">\r\n				<img src="templates/jblank/img/devices.png" alt="">\r\n			</div>\r\n			<div class="text">Создайте собственный сервис для обеспечения студентов самыми актуальными учебными материалами в видеоформате</div>\r\n			<button class="btn-scroll" type="button">Узнать подробности</button>', 1, 'header', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(88, 55, 'Преимущества', '', '			<div class="better_title">В чём преимущества использования видеоматериалов в учебном процессе?</div>\r\n			<div class="row">\r\n				<div class="col-md-4 better_item_container">\r\n					<div class="better_item">\r\n						<div class="better_item_title">Все учебные материалы<br> в одном месте</div>\r\n						<div class="better_item_text">Студенты получают возможность заниматься самостоятельно, используя материалы, максимально соответсвующие содержанию учебных курсов.</div>\r\n					</div>\r\n				</div>\r\n				<div class="col-md-4 better_item_container middle">\r\n					<div class="better_item">\r\n						<div class="better_item_title">Удобно<br>использовать</div>\r\n						<div class="better_item_text">Воспринимать информацию через видео современным студентам проще и удобнее, чем посредством статей и книг.</div>\r\n					</div>\r\n				</div>\r\n				<div class="col-md-4 better_item_container">\r\n					<div class="better_item">\r\n						<div class="better_item_title">Легко<br>обновлять</div>\r\n						<div class="better_item_text">При изменении учебных курсов достаточно лишь записать и выложить новые лекции, чтобы у студентов вновь были самые актуальные учебные материалы.</div>\r\n					</div>\r\n				</div>\r\n			</div>', 1, 'better', 651, '2016-03-14 10:52:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(89, 56, 'text1', '', '<div class="text1_title">Pulsar Video Platform — комплексное решение<br>для внедрения видеозаписей лекций в учебный процесс</div>', 0, 'text1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(90, 57, 'bullets', '', '		<div class="bullets__item b1">\r\n			<div class="bullets__item__overlay">\r\n				<div class="bullets__item__overlay__title">Видеоархив любых размеров<br> с гибким администрированием</div>\r\n				<div class="bullets__item__overlay__text">Система предоставляет круглосуточный  бесперебойный доступ к видеозаписям лекций</div>\r\n			</div>\r\n		</div>\r\n		<div class="bullets__item b2">\r\n			<div class="bullets__item__overlay">\r\n				<a class="bullets__item__overlay__title lnk" href="http://lectoriy.mipt.ru/" target="_blank">Успешный опыт <br>использования</a>\r\n				<div class="bullets__item__overlay__text">Узнайте, как сервис, созданный на базе Pulsar Video Platform, стал незаменимым помощником для студентов МФТИ</div>\r\n			</div>\r\n		</div>\r\n		<div class="bullets__item b3">\r\n			<div class="bullets__item__overlay">\r\n				<div class="bullets__item__overlay__title">Полный контроль<br> над своим контентом</div>\r\n				<div class="bullets__item__overlay__text">Выложенные видео полностью принадлежит вам, поэтому они могут содержать любой необходимый видео- и аудиоконтент</div>\r\n			</div>\r\n		</div>', 1, 'bullets', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(91, 58, 'text2', '', '			<div class="text2_title">Каким будет ваш сервис на базе Pulsar Video Platform — решать вам</div>', 0, 'text2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(92, 59, 'Опции (formats)', '', '			<div class="formats__blocks clearfix">\r\n				<div class="formats__block">\r\n					<div class="formats__block__title">Базовая версия продукта включает:</div>\r\n					<ul class="formats__block__text">\r\n						<li>Система для хранения видео</li>\r\n						<li>Администрирование и управление доступом к редактированию курсов</li>\r\n						<li>Веб-сайт для поиска и просмотра видеозаписей лекций</li>\r\n						<li>Сбор базовой статистики использования сервиса</li>\r\n						<li>Размещение системы на серверах разработчиков (при необходимости)</li>\r\n						<li>Техническая и информационная поддержка</li>\r\n					</ul>\r\n				</div>\r\n				<div class="formats__separator">\r\n					<div class="formats__separator__icon"></div>\r\n				</div>\r\n				<div class="formats__block">\r\n					<div class="formats__block__title">Возможные опции:</div>\r\n					<ul class="formats__block__text">\r\n						<li>Фирменные iOS и Android приложения</li>\r\n						<li>Интеграция с системой электронных профилей студентов университета или с уже существующей электронной системой обучения (LMS)</li>\r\n						<li>Система защиты и управления доступом к видео</li>\r\n						<li>Сбор расширенной статистики использования сервиса</li>\r\n						<li>Консультирование по любому из этапов создания видеокурсов</li>\r\n					</ul>\r\n				</div>\r\n			</div>\r\n			<div class="formats__more">Необходимы другие опции? <a class="mailto" href="mailto:sales@pulsarvp.ru" target="_blank">Напишите нам!</a></div>', 1, 'formats', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(93, 60, 'feedback', '', '			<div class="feedback_title">Узнайте подробнее, как Pulsar Video Platform сможет<br>преобразить учебный процесс в вашем университете</div>\r\n			<div class="feedback__blocks clearfix">\r\n				<div class="feedback__block">\r\n					<div class="feedback__block__title">Свяжитесь с нами</div>\r\n					<div class="feedback_phone">\r\n						<div class="feedback_phone__icon"></div>\r\n						<div class="feedback_phone__value">8-495-585-69-54</div>\r\n					</div>\r\n					<div class="feedback_mailto">\r\n						<div class="feedback_mailto__icon"></div>\r\n						<div class="feedback_mailto__value">\r\n							<a class="mailto" href="mailto:sales@pulsarvp.ru" target="_blank">sales@pulsarvp.ru</a>\r\n						</div>\r\n					</div>\r\n				</div>\r\n				<div class="feedback__separator">\r\n					<div class="feedback__separator__inner">или</div>\r\n				</div>\r\n				<div class="feedback__block">\r\n					<form id="feedback" class="clearfix" method="post" action="">\r\n						<div class="feedback__block__title">Оставьте свои контактные данные, и мы обязательно свяжемся с вами в ближайшее время</div>\r\n						<input name="name" type="text" placeholder="Ф.И.О." required>\r\n						<input name="org" type="text" placeholder="Организация" required>\r\n						<input name="position" type="text" placeholder="Должность" required>\r\n						<input name="email" type="text" placeholder="Эл. почта" required>\r\n						<button class="feedback_btn-send" type="submit">Отправить</button>\r\n						<div class="form_success_message">Спасибо! Ваша заявка отправлена!</div>\r\n					</form>\r\n				</div>\r\n			</div>', 1, 'feedback', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(94, 61, 'partners', '', '			<a href="https://mipt.ru/" class="partners__mipt" target="_blank"></a>\r\n			<a href="http://www.rusnano.com/" class="partners__rosnano" target="_blank"></a>\r\n			<a href="https://sk.ru/opus/" class="partners__skoltech" target="_blank"></a>', 1, 'partners', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(95, 62, 'footer', '', '			<div class="copyright">&copy; 2016 Pulsar Video Platform</div>\r\n			<div class="phone">8-495-585-69-54</div>', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_modules_menu`
--

CREATE TABLE IF NOT EXISTS `pvp_modules_menu` (
...
--
-- Дамп данных таблицы `pvp_modules_menu`
--

INSERT INTO `pvp_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `pvp_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `pvp_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `pvp_overrider`
--

CREATE TABLE IF NOT EXISTS `pvp_overrider` (
...
--
-- Структура таблицы `pvp_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `pvp_postinstall_messages` (
...
--
-- Дамп данных таблицы `pvp_postinstall_messages`
--

INSERT INTO `pvp_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Структура таблицы `pvp_redirect_links`
--

CREATE TABLE IF NOT EXISTS `pvp_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `pvp_schemas`
--

CREATE TABLE IF NOT EXISTS `pvp_schemas` (
...
--
-- Дамп данных таблицы `pvp_schemas`
--

INSERT INTO `pvp_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_session`
--

CREATE TABLE IF NOT EXISTS `pvp_session` (
...
--
-- Дамп данных таблицы `pvp_session`
--

INSERT INTO `pvp_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('684a3a44831927940650abc60395f893', 0, 1, '1458804934', 'joomla|s:1576:"";', 0, ''),
('7ee15428182183ac468404c4ff62543b', 1, 0, '1458804749', 'joomla|s:11168:"";', 651, 'editor');

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_tags`
--

CREATE TABLE IF NOT EXISTS `pvp_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `pvp_tags`
--

INSERT INTO `pvp_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Структура таблицы `pvp_template_styles`
--

CREATE TABLE IF NOT EXISTS `pvp_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pvp_template_styles`
--

INSERT INTO `pvp_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Структура таблицы `pvp_ucm_base`
--

CREATE TABLE IF NOT EXISTS `pvp_ucm_base` (
...
--
-- Структура таблицы `pvp_ucm_content`
--

CREATE TABLE IF NOT EXISTS `pvp_ucm_content` (
...
--
-- Структура таблицы `pvp_ucm_history`
--

CREATE TABLE IF NOT EXISTS `pvp_ucm_history` (
...
--
-- Структура таблицы `pvp_updates`
--

CREATE TABLE IF NOT EXISTS `pvp_updates` (
...
--
-- Дамп данных таблицы `pvp_updates`
--

INSERT INTO `pvp_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.5.0', '', 'https://update.joomla.org/core/sts/extension_sts.xml', '', '');

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_update_sites`
--

CREATE TABLE IF NOT EXISTS `pvp_update_sites` (
...
--
-- Дамп данных таблицы `pvp_update_sites`
--

INSERT INTO `pvp_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1458804226, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1458804226, ''),
...
--
-- Структура таблицы `pvp_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `pvp_update_sites_extensions` (
...
--
-- Дамп данных таблицы `pvp_update_sites_extensions`
--

INSERT INTO `pvp_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Структура таблицы `pvp_usergroups`
--

CREATE TABLE IF NOT EXISTS `pvp_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `pvp_usergroups`
--

INSERT INTO `pvp_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Дамп данных таблицы `pvp_users`
--

INSERT INTO `pvp_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(651, 'Super User', 'editor', 'reg@lubus.ru', '$2y$10$rFzniPXPjK6bZIbpnIIk8uqmtSlxLLMnHGPhBDxpaqQJ4HQ7O27Xa', 0, 1, '2016-02-03 13:05:26', '2016-03-24 07:23:36', '0', '{"admin_style":"","admin_language":"","language":"","editor":"codemirror","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_user_keys`
--

CREATE TABLE IF NOT EXISTS `pvp_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `pvp_user_notes`
--

CREATE TABLE IF NOT EXISTS `pvp_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pvp_user_profiles`
--

CREATE TABLE IF NOT EXISTS `pvp_user_profiles` (
...
--
-- Структура таблицы `pvp_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `pvp_user_usergroup_map` (
...
--
-- Дамп данных таблицы `pvp_user_usergroup_map`
--

INSERT INTO `pvp_user_usergroup_map` (`user_id`, `group_id`) VALUES
(651, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `pvp_viewlevels`
--

CREATE TABLE IF NOT EXISTS `pvp_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `pvp_viewlevels`
--

INSERT INTO `pvp_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
